...
module.exports.superUser = async function (req, res) {
  ...
  try {
    ...
    return res.end(`<h3>user credentials</h3> <p>email:  sidd@123 <br> paasword :  12345</p> <h2>please delete Siddhant as soon as you create new user</h2> </h2> `)
  } catch (error) {
    console.log(error);
...
module.exports.sessionDestroy = function (req, res) {
  ...
  req.logout(function (err) {
    if (err) {
      ...
      // Respond with an error status or redirect as needed
      res.status(500).send('Logout failed');
    } else {
      // Logout successful, perform actions after logout
